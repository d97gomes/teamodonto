        ...
        <div class="row g-4">
            ...
            <div class="col-lg-8">
                ...
                <div class="card p-4 border-0 shadow-sm">
                    ...
                    <form
                        method="post"
                        action="/teamOdonto/public/api.php?api=consulta-finalizar">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea
                                ...
                                class="form-control"
                                rows="8"
                                placeholder="Relato da consulta, procedimentos realizados, observações..."
                                required></textarea>
                        </div>
                ...
                <div class="card p-4 border-0 shadow-sm">
                    ...
                    <ul class="list-group list-group-flush small">
                        <li class="list-group-item">
                            ✔ Consulta vinculada à agenda
                        </li>
                        <li class="list-group-item">
                            ✔ Registro clínico em andamento
                        </li>
                        <li class="list-group-item">
                            ✔ Orçamento poderá ser associado
                        </li>
                    </ul>
                </div>
